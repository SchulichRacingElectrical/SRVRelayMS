...
type ThingOperator struct {
	...
	Operator   Operator  `gorm:"foreignKey:OperatorId;references:Id;contraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
	Thing      Thing     `gorm:"foreignKey:ThingId;references:Id;contraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
}
