...
type Sensor struct {
	Base
	SmallId              int32     `gorm:"column:small_id;not null" json:"smallId"`
	...
	ThingId              uuid.UUID `gorm:"type:uuid;column:thing_id;not null;uniqueIndex:unique_sensor_name_in_thing;uniqueIndex:unique_sensor_can_in_thing" json:"thingId"`
