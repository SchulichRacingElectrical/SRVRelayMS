...
type CollectionComment struct {
	...
	Collection   Collection `gorm:"foreignKey:CollectionId;contraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
	User         User       `gorm:"foreignKey:UserId;contraint:OnUpdate:CASCADE,OnDelete:CASCADE;"`
}
