...
-- Dumped from database version 10.20 (Ubuntu 10.20-0ubuntu0.18.04.1)
-- Dumped by pg_dump version 10.20 (Ubuntu 10.20-0ubuntu0.18.04.1)

-- Started on 2022-05-21 17:33:23 MDT
...
-- Name: sr-velocity; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "sr-velocity" WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_CA.UTF-8' LC_CTYPE = 'en_CA.UTF-8';


ALTER DATABASE "sr-velocity" OWNER TO postgres;

\connect -reuse-previous=on "dbname='sr-velocity'"
